...
3. Установим GlusterFS и базу данных PostgreSQL.<br>
4. Установка и настройка БД.<br>
5. Установка Корпоративного сервера.<br>
6. Дополнительная настройку Nginx и Сервер документов.<br>
7. Настройка подключения почтового сервера (*опционально).<br>
8. Управление переключением БД при неработоспособности первого сервера (скрипт управления).<br>
9. Резервное копирование и восстановление.<br>
