...
**Схема взаисодействия между почтовыми серверами**
...
##### $${\color{green}На сервере №1}$$
```bash
hostnamectl set-hostname r7mx1.your-domain.ru
```
>[!NOTE] 
...
##### Делаем записи в DNS.
$${\color{green}Необходимо сделать A и MX записи в виде:}$$
###### MX записи
```bash
mx1 - внешний IP
mx2 - внешний IP
